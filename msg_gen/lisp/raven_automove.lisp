...
(cl:defmethod cl:initialize-instance :after ((m <raven_automove>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'raven_automove)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name raven_BGU-msg:<raven_automove> is deprecated: use raven_BGU-msg:raven_automove instead.")))
...
(cl:defmethod del_pos-val ((m <raven_automove>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raven_BGU-msg:del_pos-val is deprecated.  Use raven_BGU-msg:del_pos instead.")
  (del_pos m))

(cl:ensure-generic-function 'tf_incr-val :lambda-list '(m))
(cl:defmethod tf_incr-val ((m <raven_automove>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raven_BGU-msg:tf_incr-val is deprecated.  Use raven_BGU-msg:tf_incr instead.")
  (tf_incr m))
